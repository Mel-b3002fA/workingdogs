...
tl.to(
  ...
  {
    yPercent: (index)=> {
      if (index ===0 || index === chars.lenght -1){
        return 0;
      }
    ...
    const cenetrX = viewportWidth/2;
    const initialCharRect = initialChar.getBoundingClientRecy();
    ...
    gsap.to([initialChar, lastChar], {
      ...
      x: (i) => {
        if (i === 0){
          return centerX - initialCharRect.left - initialCharRect.widt; 
        } else{
